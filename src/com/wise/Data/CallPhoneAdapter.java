...
public class CallPhoneAdapter extends BaseAdapter{
	...
	public CallPhoneAdapter(Context context,List<PhoneData> phoneDatas){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.tv_call_item = (TextView)convertView.findViewById(R.id.tv_phone_row_name);
			holder.tv_phone_row_phone = (TextView)convertView.findViewById(R.id.tv_phone_row_phone);
			convertView.setTag(holder);
		} else {
			holder = (ViewHolder) convertView.getTag();
		}
		holder.tv_call_item.setText(phoneDatas.get(position).getName());	
		holder.tv_phone_row_phone.setText(phoneDatas.get(position).getPhone());	
		return convertView;
	}
	private class ViewHolder {
		TextView tv_call_item,tv_phone_row_phone;
	}
}
